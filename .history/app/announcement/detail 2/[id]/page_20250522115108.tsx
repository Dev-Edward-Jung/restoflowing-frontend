...
export default function AnnouncementDetailPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.log(data.writerId == memberId)
      console.log(data.witerEmail == memberEmail?.toString())
      console.log(data.writerRole == memberRole)
  ...
  useEffect(() => {
    if (memberId && memberRole && memberEmail) {
      fetchData();
    }
    fetchData();
