...
export default function AnnouncementDetailPage() {
  ...
  useEffect(() => {
    ...
    console.log(announcement.writerId == memberId)
    console.log(announcement.witerEmail == memberEmail?.toString())
    console.log(announcement.writerRole == memberRole)

  }, [announcement, restaurantId, memberId, memberRole, memberEmail]);
    ...
    <div className='wrapper'>
      ...
      {announcement ? (
        <div className="card p-4">
          ...
          {announcement.writerId == memberId?.toString() &&
           announcement.writerName == memberEmail?.toString() && 
           announcement.writerRole == memberRole?.toString() && (
