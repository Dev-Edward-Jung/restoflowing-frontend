...
export default function ScheduleEditClientPage() {
  ...
  const renderSelect = (value: string) => (
    <select
      ...
      defaultValue={value}
    >
      <option className='bg-label-primary' value="FULL_TIME">Full Time</option>
      <option className='bg-label-info' value="DINNER">Dinner</option>
      <option className='bg-label-success' value="LUNCH">Lunch</option>
      <option className='bg-label-warning' value="OFF">Off</option>
    </select>
  );
