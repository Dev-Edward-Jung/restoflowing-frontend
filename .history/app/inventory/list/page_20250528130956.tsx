      ...
      <div className="container p-4">
        ...
        {Object.entries(
          ...
          <div key={category}>
            <h5>{category}</h5>
            {items.map(item => (
  <div key={item.id + '-' + item.quantity + '-' + item.unit} className="d-flex gap-2 mb-2 align-items-center">
    <input className="form-control" disabled value={item.name} />
    <input className="form-control" disabled type="number" value={item.quantity} />
