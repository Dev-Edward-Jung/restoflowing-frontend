                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="text-center p-2">
                                <a href="/auth/owner/login" className="d-flex align-items-center justify-content-center">
                                    <i className="bx"></i>
                                    Back to owner login
                                </a>
                            </div>
                            ...
                            <div className="text-center p-2">
                                <a href="/auth/employee/login" className="d-flex align-items-center justify-content-center">
                                    <i className="bx"></i>
